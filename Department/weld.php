<?php
include_once('../routes/WeldAssy_schedule.php');
?>
<!DOCTYPE html>
<html lang='en'>
<head>
    ...
    <meta name='author' content='Technique Inc. Weld Assy Job Schedule, Developer: Nathan Creger'/>
    <meta charset='utf-8'>
    <meta name='viewport' content='width=device-width, initial-scale=1, shrink-to-fit=yes'>
    <title>WeldAssy Schedule</title>
    ...
    $(document).ready(function(){
        $('#export').on('click',function(){
            $('.table2excel').table2excel({
                name: 'WeldAssy Schedule',
                filename: 'WeldAssy_Schedule.xls',
                preserveColors: true,
                exclude_links: false,
                exclude_img: true
            });
