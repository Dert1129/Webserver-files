<?php
include_once('../routes/2D_Laser_Schedule.php');
?>
<!DOCTYPE html>
<html lang='en'>
<head>
    ...
    <meta name='author' content='Technique Inc. 2D Laser Job Schedule, Developer: Nathan Creger'/>
    <meta charset='utf-8'>
    <meta name='viewport' content='width=device-width, initial-scale=1, shrink-to-fit=yes'>
    <title>2D Laser Job Schedule</title>
        ...
        <div class='container-fluid'>
            <div class='table-responsive'>
                <div class='table-wrapper'>
                    ...
                    <div class='row'>
                        <div class='display-4 mx-auto'>2D Laser Schedule</div>
                    </div>
