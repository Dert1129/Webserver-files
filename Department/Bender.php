...
<head>
    ...
    <meta name='author' content='Technique Inc. Tube Bender Job Schedule, Developer: Nathan Creger'/>
    <meta charset='utf-8'>
        ...
        <div class='container-fluid'>
            <div class='table-responsive'>
                <div class='table-wrapper'>
                    ...
                    <div class='row'>
                        <div class='display-4 mx-auto'>Tube Bending Schedule</div>
                    </div>
    ...
    $(document).ready(function(){
        $('#export').on('click',function(){
            $('.table2excel').table2excel({
                name: 'Tube Bender',
                filename: 'Tube_Bender_Schedule.xls',
                preserveColors: true,
                exclude_links: false,
                exclude_img: true
            });
