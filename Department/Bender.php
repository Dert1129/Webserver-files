...
<head>
    ...
    <title>Tube Bender Job Schedule</title>
        ...
        <div class='container-fluid'>
            <div class='table-responsive'>
                <div class='table-wrapper'>
                    ...
                    <div class='row'>
                        <div class='display-4 mx-auto'>Tube Bender Schedule</div>
                    </div>
                    <div class='input-group mb-3 row mx-auto my-auto'>
                            ...
                            <div class='input-group-btn dropdown'>
                                ...
                                <div class='dropdown-menu checkbox-menu allow-focus' aria-labelledby='dd'>
                                    ...
                                    <a class="dropdown-item" href="http://localhost:8080/Department/brake.php">Brake & Baltech Schedule</a>
                                </div>
                            </div>
                        </div>
