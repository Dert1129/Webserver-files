<?php
include_once('../routes/Tooling_schedule.php');
?>
<!DOCTYPE html>
<html lang='en'>
<head>
        ...
        <div class='container-fluid'>
            <div class='table-responsive'>
                <div class='table-wrapper'>
                    ...
                    <div class='row'>
                        <div class='display-4 mx-auto'>Tooling Schedule</div>
                    </div>
                    <div class='input-group mb-3 row mx-auto my-auto'>
                            ...
                            <div class='input-group-btn dropdown'>
                                ...
                                <div class='dropdown-menu checkbox-menu allow-focus' aria-labelledby='dd'>
                                    ...
                                    <a class="dropdown-item" href="http://localhost:8080/Department/Tube.php">Tube Laser Schedule</a>
                                    <a class="dropdown-item" href="http://localhost:8080/Department/spacegear.php">Spacegear Schedule</a>
                                    <a class="dropdown-item" href="http://localhost:8080/Department/weld.php">WeldAssy Schedule</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <table id='sortTable' class='table2excel table table-striped tablesorter table-sm'>
                                <thead>
                                    <tr style='text-align: left header' id='Headers'>
                                        ...
                                        <th class='col-1'>Quantity To Stock</th>
                                        <th class='col-1'>Design Complete</th>
