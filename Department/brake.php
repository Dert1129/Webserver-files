...
<head>
    ...
    <meta name='author' content='Technique Inc. Brake & Baltec Job Schedule, Developer: Nathan Creger'/>
    <meta charset='utf-8'>
    ...
    $(document).ready(function(){
        $('#export').on('click',function(){
            $('.table2excel').table2excel({
                name: 'Brake & Baltec Schedule',
                filename: 'Brake_Baltec.xls',
                preserveColors: true,
                exclude_links: false,
                exclude_img: true
            });
