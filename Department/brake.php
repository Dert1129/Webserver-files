<?php
include_once('../routes/brake_schedule.php');
?>
<!DOCTYPE html>
<html lang='en'>
<head>
    ...
    <title>Brake Job Schedule</title>
        ...
        <div class='container-fluid'>
            <div class='table-responsive'>
                <div class='table-wrapper'>
                    ...
                    <div class='row'>
                        <div class='display-4 mx-auto'>Brake & Baltech Schedule</div>
                    </div>
                    <div class='input-group mb-3 row mx-auto my-auto'>
                            ...
                            <div class='input-group-btn dropdown'>
                                ...
                                <div class='dropdown-menu checkbox-menu allow-focus' aria-labelledby='dd'>
                                    ...
                                    <a class="dropdown-item" href="http://localhost:8080/Department/WeldAssy.php">WeldAssy Schedule</a>
                                </div>
                            </div>
                        </div>
