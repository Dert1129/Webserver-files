<?php
include_once('../routes/Stamping_Schedule.php');
?>
<!DOCTYPE html>
<html lang='en'>
<head>
    ...
    <meta name='author' content='Technique Inc. Stamping Job Schedule, Developer: Nathan Creger'/>
    <meta charset='utf-8'>
    <meta name='viewport' content='width=device-width, initial-scale=1, shrink-to-fit=yes'>
    <title>Stamping Job Schedule</title>
        ...
        <div class='container-fluid'>
            <div class='table-responsive'>
                <div class='table-wrapper'>
                    ...
                    <div class='row'>
                        <div class='display-4 mx-auto'>Stamping Schedule</div>
                    </div>
    ...
    $(document).ready(function(){
        $('#export').on('click',function(){
            $('.table2excel').table2excel({
                name: 'Stamping Schedule',
                filename: 'Stamping_Schedule.xls',
                preserveColors: true,
                exclude_links: false,
                exclude_img: true
            });
